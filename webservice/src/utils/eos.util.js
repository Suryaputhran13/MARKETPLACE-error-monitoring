...
const signatureProvider = new JsSignatureProvider([eosConfig.dgoodsPassword]);
...
const transact = async (actions, auths) => {
  try {
    console.log("EOS ACTIONS", actions);
    console.log("EOS AUTHS", auths);
    console.log("EOS rpc", rpc);
    console.log("EOS textDecoder", textDecoder);
    console.log("EOS textEncoder", textEncoder);
    console.log("EOS chainId", eosConfig.chainId);
    ...
    //   } catch (error) {}
    // }
    keys.push("5Jg1kRnbTAPwsKxgEq18BqmMotUCwvAetoEdMhT9kbtmQMcGpNH", "5JhmxHoxiu3b4ErLUJqX5rNArpzKN3gTsCbi5J9k2GNFSpPeMXD")
    const api = new Api({
      rpc,
      textDecoder,
      textEncoder,
